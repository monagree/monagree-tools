...
exports.getDocId = exports.getData = exports.fireMan = exports.getACT = void 0;
var axios_1 = __importDefault(require("axios"));
function getACT(finise) {
    axios_1.default.post('https://us-central1-monagree-felix.cloudfunctions.net/generateOAuthToken', {
        key: 'rondanfel1357913'
...
var fireMan = /** @class */ (function () {
    ...
    fireMan.prototype.setFS = function (path, pld, task) {
        ...
        var firestoreUrl = "https://firestore.googleapis.com/v1/projects/monagree-felix/databases/(default)/documents/".concat(path);
        var headers = {
